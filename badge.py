...
def makeQR(fill_color, back_color):
    ...
    qr = qrcode.QRCode(version=4, box_size=15)
    qr.add_data(url)
    qr.make()
...
if theme == "dark":
    img = round_rectangle((880, 760), 35, (229, 229, 229), (26, 26, 26))
    img1 = round_rectangle((870, 750), 30, (26, 26, 26), (0, 0, 0))
    make_background((26, 26, 26), img, img1, (208, 208, 208), "white")
    makeQR("white", "#1a1a1a")
    addText("white", (255, 255, 255))
else:
    img = round_rectangle((880, 760), 35, (197, 196, 202), (255, 255, 255))
    img1 = round_rectangle((870, 750), 30, (255, 255, 255, 255), (0, 0, 0))
    make_background((255, 255, 255), img, img1, (255, 255, 255), (197, 196, 202))
    makeQR("black", "#ffffff")
